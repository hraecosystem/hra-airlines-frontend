    ...
    >
      <div className="w-full max-w-md bg-white border border-red-200 p-8 rounded-2xl shadow-lg text-center space-y-4">
        ...
        <p className="text-sm text-gray-500">
          Redirecting back to booking in{" "}
        ...
        <motion.button
          ...
          className="mt-4 inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium transition"
        >
          🔁 Go Back Now
        </motion.button>
      </div>
